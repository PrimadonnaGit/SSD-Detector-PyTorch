...
class MultiBoxLoss(nn.Module):
    ...
    def forward(self, predicted_locs, predicted_scores, boxes, labels):
        ...
        for i in range(batch_size):
            ...
            overlap_for_each_prior, object_for_each_prior = overlap.max(dim=0) # (8732) max -> values, indices

            # We don't want a situation where an object is not represented in out positive (non-background) priors
        ...
        # This is called Hard Negative Mining - it concentrates on hardest negatives in each image, and also minimize pos/neg imbalance
